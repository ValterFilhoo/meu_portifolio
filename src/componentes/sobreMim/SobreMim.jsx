            ...
            <section className="w-[80%] m-auto mt-20">
                    ...
                    <ul className="list-inside text-lg font-serif break-words">
                        ...
                        <div className="mt-5 mb-5">
                            ...
                            <li className="mb-5">Projetos Autorais:</li>
                                ...
                                <ul className="list-disc list-inside text-lg font-serif break-words">
                                    ...
                                    <li className="ml-10 text-justify">Desenvolvi um protótipo de portal de notícias usando Figma. Inicialmente implementado com HTML e CSS, estou atualmente refazendo-o com React.js e Express.js.</li>
                        ...
                        <div className="mt-5 mb-5">
                            ...
                            <li className="mb-5">Desenvolvimento Web:</li>
                                ...
                                <ul className="list-disc list-inside text-lg font-serif break-words">
                                    ...
                                    <li className="ml-10 text-justify">Participei da criação de um site de vendas de acessórios, utilizando HTML, CSS, JavaScript, PHP e MySQL.</li>
                        ...
                        <div className="mt-5 mb-5">
                            ...
                            <ul className="list-disc list-inside text-lg font-serif break-words">
                                ...
                                <li className="ml-10 text-justify">Estou desenvolvendo um aplicativo Android com detecção de objetos orientado a comandos de voz personalizados, utilizando Kotlin, para auxiliar pessoas cegas e de baixa visão.</li>
                        ...
                        <div className="mt-5 mb-5">
                            ...
                            <li className="mb-5">Projetos Acadêmicos:</li>
                                ...
                                <ul className="list-disc list-inside text-lg font-serif break-words">
                                    ...
                                    <li className="ml-10 text-justify">Participei da implementação de dois sistemas web, sendo um utilizando HTML, CSS, JS, PHP e MySQL, e o outro fazendo uso das mesmas tecnologias, mas aplicando padrões de projetos.</li>
                ...
                <div className="w-[80%] m-auto">
                    ...
                    <ul className="list-disc text-lg font-serif break-words">
                        <li className="mb-3">Desenvolvimento Web: HTML, CSS, JavaScript, PHP, MySQL, React.js e Tailwind; </li>
                        <li className="mb-3">Desenvolvimento Mobile: Kotlin;</li>
                        <li className="mb-3">UI/UX Design: Princípios e práticas de design de interfaces;</li>
                        <li className="mb-3">Metodologias Ágeis: Conhecimento teórico de SCRUM e XP;</li>
                        <li className="mb-3">Banco de Dados: MySQL;</li>
                        <li className="mb-3">Orientação a Objetos: Conhecimento teórico e aplicação prática.</li>
                    </ul>
