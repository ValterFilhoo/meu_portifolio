  ...
  return (
    ...
    <header className="flex bg-gray-950 w-full">
      ...
      <nav>
          ...
          <ul className={`flex flex-col  ${menuClicado ? "flex items-center w-[40%] bg-white absolute shadow-2xl sm:right-0 sm:top-41 md:top-41 p-4 gap-5 rounded-md max-sm:right-0 max-sm:top-41 max-sm:w-[50%] "  : "hidden"}`}>
